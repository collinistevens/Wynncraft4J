...
public enum CharacterGamemode {
    @SerializedName("hardcore") HARDCORE("Hardcore", "H", TextColor.RED),
    @SerializedName("ultimate_ironman") ULTIMATE_IRONMAN("Ultimate Ironman", "UI", TextColor.AQUA),
    @SerializedName("ironman") IRONMAN("Ironman", "I", TextColor.GOLD),
    @SerializedName("craftsman") CRAFTSMAN("Craftsman", "C", TextColor.DARK_AQUA),
    @SerializedName("hunted") HUNTED("Hunted", "H", TextColor.LIGHT_PURPLE);
